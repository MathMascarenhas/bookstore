...
import { StarRate } from "../../atoms/stars/stars";
...
export function AddBook({ handleModal, setControl, control, editMode, book} : Props) {
   ...
   <StyledBookForm>
        ...
        <input type="text" name="imageUrl" defaultValue={editMode ? book.imageUrl : ""}  required></input>
        ...
        <input type="number"  step="0.01" name="price" defaultValue={editMode ?book.price : ""} required></input>
